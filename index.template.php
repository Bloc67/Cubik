...
<body id="', $context['browser_body_id'], '" class="' . $bchecks . ' ' , $context['user']['is_guest'] ? 'is_guest ' : '' , 'action_', !empty($context['current_action']) ? htmlspecialchars($context['current_action'], ENT_COMPAT, 'UTF-8') : (!empty($context['current_board']) ?
...
function tchecks()
{
	...
	// special checks
	if(!empty($context['linked_calendar_events'][0]))
		$hits[] = 'calendar_post';
